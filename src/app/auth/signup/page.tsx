          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <select value={plan} onChange={e => setPlan(e.target.value)}
                ...
                <option value="free">Free — S$0/month</option>
                <option value="starter">Starter — S$29/month</option>
                <option value="pro">Pro — S$79/month</option>
                <option value="agency">Agency — S$299/month</option>
              </select>
            </div>
